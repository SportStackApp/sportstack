...
const MVP_ERROR_MESSAGES: Record<string, string> = {
  ...
  MVP_SESSION_EXPIRED: "The voting deadline has passed and this round is closed.",
  MVP_SESSION_DEADLINE_PASSED: "The voting deadline has passed and this round is closed.",
