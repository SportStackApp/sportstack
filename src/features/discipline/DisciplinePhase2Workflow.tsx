...
const FIELD_LAYOUT: Record<Phase2Stage, Array<[string, string, "text" | "email" | "datetime-local" | "textarea" | "checkbox"]>> = {
  ...
  APPEAL: [
    ...
    ["applicant_and_grounds", "Appellant and grounds", "textarea"], ["cooperation_eligibility", "Cooperation and appeal eligibility assessment", "textarea"],
    ["panel_appointment_authority", "Appeal Board appointment authority", "text"], ["panel_composition", "Three-member Appeal Board composition", "textarea"],
    ["qualified_chair_confirmed", "Chair legal-practice eligibility confirmed", "checkbox"], ["panel_independence_confirmed", "Every panel member passed the independence checks", "checkbox"],
    ["affected_people_heard", "Directly affected people given a reasonable opportunity to be heard", "checkbox"], ["new_hearing_on_merits", "Appeal conducted as a new hearing on the merits", "checkbox"],
    ["appeal_majority_basis", "Appeal Board majority basis", "textarea"],
  ...
  CLOSURE: [
    ...
    ["decision_notice_reference", "Decision-notification reference", "text"], ["sanctions_register_updated", "Sanction register updated where required", "checkbox"],
    ["administrative_fee_treatment", "Administrative fee and local authority treatment", "textarea"],
